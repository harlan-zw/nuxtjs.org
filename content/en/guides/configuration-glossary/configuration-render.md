...
When deploying your app as a [SSG](https://nuxtjs.org/docs/2.x/concepts/static-site-generation), having `asyncScripts: true` can result in hydration race conditions where the pre-generated payload is downloaded as well as the asyncData being called without a payload. Use with caution.
